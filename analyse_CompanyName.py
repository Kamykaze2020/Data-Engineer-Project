...
google_df['Company Name'] = google_df['Company Name'].str.lower()
facebook_df['Company Name'] = facebook_df['Company Name'].str.lower()
website_df['Company Name'] = website_df['Company Name'].str.lower()
...
# google_df.to_csv('NEWDATASET/new_google_dataset.csv', index=False)
# facebook_df.to_csv('NEWDATASET/new_facebook_dataset.csv', index=False)
# website_df.to_csv('NEWDATASET/new_website_dataset.csv', index=False)